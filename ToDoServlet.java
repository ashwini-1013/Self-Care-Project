...
import com.self.care.entities.Routine;
...
public class ToDoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String routineText = request.getParameter("routineText");

            HttpSession s = request.getSession();
            User user = (User) s.getAttribute("currentUser");

            Routine routine = new Routine(routineText, user.getId());

            Database dao = new Database(Database.getConnection());
            if (dao.saveRoutine(routine)) {
                out.println("done");
